...
export const buffs = [{
  ...
  title: '2命：提高300点基础攻击力,获得[aPlus]点驰轮车普攻加成值,获得[a2Plus]点驰轮车重击加成值',
  cons: 2,
  data: {
    atk: 300,
    aPlus: ({ talent, attr, calc }) => calc(attr.atk) * 1,
    a2Plus: ({ talent, attr, calc }) => calc(attr.atk) * 1.5
  }
}]
