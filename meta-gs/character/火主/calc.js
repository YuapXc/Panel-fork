export const details = [{
  ...
  title: '[E]快快火环伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['快快火环伤害'], 'e')
},{
  title: '[E]慢慢火环即时伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['慢慢火环即时伤害'], 'e')
},{
  title: '[E]慢慢火环伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['慢慢火环伤害'], 'e')
},{
  title: '[Q]厝火燎原伤害',
  ...
  title: '[E]快快火环蒸发伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['快快火环伤害'], 'e','vaporize')
},{
  title: '[E]慢慢火环即时蒸发伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['慢慢火环即时伤害'], 'e','vaporize')
},{
  title: '[E]慢慢火环蒸发伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['慢慢火环伤害'], 'e','vaporize')
},{
  title: '[Q]厝火燎原蒸发伤害',
  dmgKey: 'AE',
