export const details = [{
  ...
  title: '[A]低空坠地冲击伤害',
  dmg: ({ talent }, dmg) => dmg(talent.a['低空/高空坠地冲击伤害'][0], 'a')
}, {
  title: '[A]高空坠地冲击伤害',
  dmg: ({ talent }, dmg) => dmg(talent.a['低空/高空坠地冲击伤害'][1], 'a')
}, {
  title: '[E]秘药弹伤害',
  dmg: ({ talent }, dmg) => dmg(talent.e['秘药弹伤害'], 'e')
}, {
  title: '[E]秘药弹命中治疗量',
  dmg: ({ attr, talent }, { heal }) => heal(attr.mastery * talent.e['秘药弹命中治疗量'][0] + talent.e['秘药弹命中治疗量'][1])
}, {
  title: '[Q]复合镇静域伤害',
  dmg: ({ talent }, dmg) => dmg(talent.q['技能伤害'], 'q')
}, {
  title: '[Q]镇静标记伤害',
  dmg: ({ talent }, dmg) => dmg(talent.q['镇静标记伤害'], 'q')
}];
