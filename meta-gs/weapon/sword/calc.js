export default function (step, staticStep) {
  return {
    ...
    赦罪: {
      title: '暴击伤害提升[cdmg]%，三层造成的伤害提升[dmg]%',
      refine: {
        cdmg: [20,25,30,35,40],
        dmg: [48,60,72,84,96]
      }
    ...
    息燧之笛: {
      title: '防御力提升[defPct]%',
      refine: {
        defPct: [16, 20, 24, 28, 32]
      }
    },
    岩峰巡歌: {
      title: '防御力提升[defPct]%,普通攻击和下落攻击的暴击率和暴击伤害分别提高[acpct]%/[a3cdmg]%',
      refine: {
        defPct: [10*2,12.5*2,15*2,17.5*2,20*2],
        acpct: [3.2,4,4.8,5.6,6.4],
        acdmg: [25.6,32,38.4,44.8,51.2],
        a3cpct: [3.2,4,4.8,5.6,6.4],
        a3cdmg: [25.6,32,38.4,44.8,51.2]
      }
    },
    弥坚骨: {
      title: '提升普通攻击伤害[aPlus]点',
      data: {
        aPlus: ({ attr, calc, refine }) => calc(attr.atk) * step(16)[refine]
      }
    },
