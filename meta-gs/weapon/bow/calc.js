export default function (step, staticStep) {
  return {
    ...
    白雨心弦: {
      title: '3层疗护时，生命值上限提升[hpPct]%，元素爆发的暴击率提升[cpct]%',
      refine: {
        hpPct: [40,50,60,70,80],
        qCpct: [28,35,42,49,56]
      }
    },
    筑云: {
      title: '装备者的元素精通提升[mastery]点',
      refine: {
        mastery: [80,100,120,140,160]
      }
    },
    缀花之翎: {
      title: '重击伤害提升[a2Dmg]点',
      refine: {
        a2Dmg: [36,45,54,63,72]
      }
    },
    星鹫赤羽: {
      title: '攻击力提高[atkPct]%,重击伤害提高[a2Dmg]%,元素爆发伤害提高[qDmg]%,',
      refine: {
        atkPct: [24,30,36,42,48],
        a2Dmg: [48,60,72,84,96],
        qDmg: [24,30,36,42,48]
      }
    },
    碎链: {
      title: '装备者的攻击力提升[atkPct]%',
      refine: {
        atkPct: [4.8,6,7.2,8.4,9.6]
      }
    },
    静谧之曲: {
