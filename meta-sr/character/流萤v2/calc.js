export const details = [{
  ...
  title: '[A+]强化普攻击破状态伤害',
  params: { team: false,teamA: true,teamB: false,teamC: false,Q: true },
  dmg: ({ talent }, dmg) => dmg(talent.a2['技能伤害'], 'a')
},{
  title: '[E]天火轰击伤害',
  ...
  title: '[E+]强化战技主目标伤害',
  params: { team: false,teamA: false,teamB: false,teamC: false,Q: true },
  dmg: ({ talent,calc, attr }, dmg) => dmg(talent.e2['主目标伤害'] + ((0.5 * calc(attr.stance)) * 0.1), 'e')
},{
  check: ({ calc, attr }) => calc(attr.stance) < 360,
  title: '[E+]强化战技主目标击破状态伤害',
  dmgKey: 'AE',
  params: { team: false,teamA: true,teamB: false,teamC: false,Q: true },
  dmg: ({ talent,calc, attr }, dmg) => dmg(talent.e2['主目标伤害'] + ((0.5 * calc(attr.stance)) * 0.1), 'e')
},{
  ...
  title: '[E+]强化战技相邻目标伤害',
  params: { team: false,teamA: false,teamB: false,teamC: false,Q: true },
  dmg: ({ talent,calc, attr }, dmg) => dmg(talent.e2['相邻目标伤害'] + ((0.25 * calc(attr.stance)) * 0.1), 'e')
},{
  check: ({ calc, attr }) => calc(attr.stance) < 360,
  title: '[E+]强化战技相邻目标击破状态伤害',
  params: { team: false,teamA: true,teamB: false,teamC: false,Q: true },
  dmg: ({ talent,calc, attr }, dmg) => dmg(talent.e2['相邻目标伤害'] + ((0.25 * calc(attr.stance)) * 0.1), 'e')
},{
  ...
  title: '[E+]强化战技主目标伤害',
  params: { team: false,teamA: false,teamB: false,teamC: false,Q: true },
  dmg: ({ talent,calc, attr }, dmg) => dmg(talent.e2['主目标伤害'] + ((0.5 * 360) * 0.1), 'e')
},{
  check: ({ calc, attr }) => calc(attr.stance) > 359,
  title: '[E+]强化战技主目标击破状态伤害',
  dmgKey: 'AE',
  ...
  title: '[E+]强化战技相邻目标伤害',
  params: { team: false,teamA: false,teamB: false,teamC: false,Q: true },
  dmg: ({ talent,calc, attr }, dmg) => dmg(talent.e2['相邻目标伤害'] + ((0.25 * 360) * 0.1), 'e')
},{
  check: ({ calc, attr }) => calc(attr.stance) > 359,
  title: '[E+]强化战技相邻目标击破状态伤害',
  params: { team: false,teamA: true,teamB: false,teamC: false,Q: true },
  ...
  title: '[流阮花藿-A+]强化普攻击破状态伤害',
  params: { team: true,teamA: true,teamB: false,teamC: false,Q: true },
  dmg: ({ talent }, dmg) => dmg(talent.a2['技能伤害'], 'a')
},{
  title: '[流阮花藿-E]天火轰击伤害',
  params: { team: true,teamA: false,teamB: false,teamC: false,Q: false },
...
export const buffs = [{
  check: ({ params,calc, attr }) => params.Q === true && calc(attr.stance) >= 250 && calc(attr.stance) < 360,
  title: '核心过载：无视目标30%防御力',
  data: {
    ignore: 30
  }
},{
  check: ({ params,calc, attr }) => params.Q === true && calc(attr.stance) >= 360,
  ...
  title: '自我限制护甲：2500攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 2600,
  title: '自我限制护甲：2600攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 2700,
  title: '自我限制护甲：2700攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 2800,
  title: '自我限制护甲：2800攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 2900,
  title: '自我限制护甲：2900攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 3000,
  title: '自我限制护甲：3000攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 3100,
  title: '自我限制护甲：3100攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 3200,
  title: '自我限制护甲：3200攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 3300,
  title: '自我限制护甲：3300攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
  check: ({ calc, attr }) => calc(attr.atk) >= 3400,
  title: '自我限制护甲：3400攻击力,击破特攻提升[stance]%',
  data: {
    stance: 6
  }
},{
