export const details = [{
  ...
  title: '[Q]大招最多造成的伤害',
  dmg: ({ talent }, dmg) => dmg(talent.q['最高伤害'], 'q')
},{
  title: '[飞鸟花灵-E]钺贯伤害',
  params: { team: true },
  dmg: ({ talent }, dmg) => dmg(talent.e['技能伤害'], 'e')
...
export const buffs = [{
  ...
  check: ({ cons, params }) =>  params.team === true,
  title: '知更鸟：攻击提升[atkPlus]点,知更鸟专武提升伤害[dmg]%,龙骨套暴击伤害提高10%。',
  data: {
    atkPlus: 1400,
    dmg: 24,
    cdmg: 10
