export const details = [{
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (2 + 2) / 4 * talent.t['击破伤害A']
    }
  }
}, {
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (10 + 2) / 4 * talent.t['击破伤害A']
    }
  }
}, {
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (16 + 2) / 4 * talent.t['击破伤害A']
    }
  }
},{
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (24 + 2) / 4 * talent.t['击破伤害A']
    }
  }
},{
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (2 + 2) / 4 * talent.t['击破伤害B']
    }
  }
}, {
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (10 + 2) / 4 * talent.t['击破伤害B']
    }
  }
}, {
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (16 + 2) / 4 * talent.t['击破伤害B']
    }
  }
},{
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (24 + 2) / 4 * talent.t['击破伤害B']
    }
  }
},{
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (2 + 2) / 4 * talent.t['击破伤害C']
    }
  }
}, {
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (10 + 2) / 4 * talent.t['击破伤害C']
    }
  }
}, {
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (16 + 2) / 4 * talent.t['击破伤害C']
    }
  }
},{
  ...
  dmg: ({ talent }, { reaction }) => {
    return {
      avg: reaction('physicalBreak').avg / 0.9 * (24 + 2) / 4 * talent.t['击破伤害C']
    }
  }
},{
  title: '[Q]尘魔舞者的日落秀伤害',
