export const details = [{
  ...
  title: '[A]孤锋千吻-主目标全部伤害',
  dmgKey: 'AE',
  dmg: ({ talent }, dmg) => dmg(talent.a2['阿格莱雅主目标伤害'] + talent.a2['衣匠主目标伤害'], 'a')
},{
  title: '[A]孤锋千吻-相邻目标单次伤害',
  dmg: ({ talent }, dmg) => dmg(talent.a2['阿格莱雅相邻目标伤害'], 'a')
},{
  title: '[A]孤锋千吻-相邻目标全部伤害',
  dmg: ({ talent }, dmg) => dmg(talent.a2['阿格莱雅相邻目标伤害'] + talent.a2['衣匠相邻目标伤害'], 'a')
},{
  title: '[E]回复衣匠生命值治疗量',
