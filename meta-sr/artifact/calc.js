...
export default {
  ...
  谧宁拾骨地: {
    2: [attr('hpPct', 12), {
      title: '生命上限大于等于5000点时，使装备者及其忆灵的暴击伤害提高28%。',
  ...
  渊思寂虑的巨树: {
    2: [attr('speedPct', 6), {
      title: '装备者速度大于[_speed]时，使装备者及其忆灵的治疗量提高[heal]%',
  ...
  哀歌覆国的诗人: {
    ...
    4: [{
      ...
      title: '速度降低8%,暴击率提高20%',
      check: ({ attr }) => attr.speed > 95 && attr.speed <= 110,
      data: {
        cpct: 20,
        speedPct: -8
      }
