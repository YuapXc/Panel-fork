...
export default {
  ...
  劫火莲灯铸炼宫: {
    2: [attr('speedPct', 6),attr('stance', 40), {
      title: '击破特攻提高40%',
      data: {
        stance: 40
      }
  ...
  荡除蠹灾的铁骑: {
    2: attr('stance', 16),
    4: {
      title: '装备者击破特攻大于等于[_stance]时无视其[ignore]%防御力',
      check: ({ attr }) => attr.stance >= 150,
      data: {
        _stance: ({ attr }) => attr.stance < 250 ? 150 : 250,
        ignore: ({ attr }) => attr.stance < 250 ? 10 : 18
      }
    }
  },
  野穗伴行的快枪手: {
  ...
  奔狼的都蓝王朝: {
    2: [attr('cpct', 0), {
      title: '功勋六层-追加攻击造成的伤害提高[tDmg]%,暴击伤害提高[cdmg]%',
      data: {
        cdmg: 24,
        tDmg: 24
      }
